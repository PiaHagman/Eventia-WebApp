...
namespace EventiaWebapp.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventEventiaUser", x => new { x.AttendeesId, x.JoinedEventsId });
                    table.ForeignKey(
                        name: "FK_EventEventiaUser_AspNetUsers_AttendeesId",
                        column: x => x.AttendeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventEventiaUser_Events_JoinedEventsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventEventiaUser_JoinedEventsId",
                table: "EventEventiaUser",
